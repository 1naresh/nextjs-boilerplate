    ...
    <div>
      <Header style={{ display: "flex", alignItems: "center" }}>
        <div className="demo-logo" style={{ height: "64px" }}>
          <Image preview={false} style={{ width: "117px" }} src={"/logo.png"} alt="logo" />
        </div>
      ...
      <div style={{ width: "100%" }} className="ae-carousel">
        <Carousel autoplay >
          <div>
            <div className="ae-carousel-img">
              {" "}
              <Image preview={false} className="img1" style={{ width: "100%" }} src={"/caro2.jpeg"} alt="logo" />
            </div>
          </div>
          <div>
            <div className="ae-carousel-img">
              {" "}
              <Image preview={false} style={{ width: "70%",transform:"translateY(-10px)",margin:"0 15%" }} src={"/caro3.jpeg"} alt="logo" />
            </div>
          </div>
          <div>
            <div className="ae-carousel-img">
              <Image preview={false} style={{ width: "100%",transform:"translateY(-10px)" }} src={"/caro4.jpeg"} alt="logo" />
            </div>
          </div>
        </Carousel>
      </div>
